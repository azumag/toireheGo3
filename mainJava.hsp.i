...
mmload@hsp "data/music/stage1.mid", 4
mmload@hsp "data/music/boss01a.mid", 2
mmload@hsp "data/music/boss01b.mid", 3
mmload@hsp "data/music/sea2.mid", 5
mmload@hsp "data/music/stage2.mid",6
mmload@hsp "data/music/katyhilla.mid",8
mmload@hsp "data/music/katyhill_intro.mid",7
mmload@hsp "data/music/Done_Gone.mid",18		
mmload@hsp "data/music/bbb_f.mid",19			
mmload@hsp "data/music/bbb_s.mid",20			
mmload@hsp "data/music/bbb_t.mid",21			
mmload@hsp "data/music/BBBS.mid",22				
mmload@hsp "data/music/end.mid",16				
mmload@hsp "data/music/Morning_Drive.mid",17
...
ket=limit@hsp(ket,220,220)
menu=limit@hsp(menu,0,0)
...
cls@hsp
mes@hsp "Now loading"
if@hsp stage=1:mmplay@hsp 4:kyokumei="Orange Blossom Special"
...
if@hsp shotpower>=120:life+=1:shotpower=0

shotlv+=1
shotpower+=1
if@hsp shotlv>=3:shotlv=4
if@hsp shotlv<=3:dansu+=2:
}
...
if@hsp objtimek.cnt@hsp=1:mmstop@hsp:mmplay@hsp 8
...
if@hsp objtimek.cnt@hsp = 21 	:txv.cnt@hsp=0:tyv.cnt@hsp=0:mmplay@hsp 19
if@hsp objtimek.cnt@hsp = 160 	:txv.cnt@hsp=0:tyv.cnt@hsp=0
if@hsp objtimek.cnt@hsp = 370 	:stage=6:mmplay@hsp 20
if@hsp objtimek.cnt@hsp = 400	:txv.cnt@hsp=0:tyv.cnt@hsp=0
if@hsp objtimek.cnt@hsp = 1100	:mmplay@hsp 19
...
if@hsp objtimek.cnt@hsp=1902|kg=1:efx_f=160:efy_f=160:efx_e=160:efy_e=160:utot=0
...
if@hsp cannon = 3 : target = cnt@hsp : gosub@hsp *bosshit :dis.cnt@hsp = 1 :cannon = 0: 
...
if@hsp objtimek.cnt@hsp=302|kg=1:efx_f=160:efy_f=160:efx_e=160:efy_e=160:utot=0
...
if@hsp objtimek2.cnt@hsp>=50{
objtimek.cnt@hsp+=1
if@hsp (objtimek.cnt@hsp*5)>=180:objtimek2.cnt@hsp=0:objtimek.cnt@hsp=0:tyv.cnt@hsp=0
...
if@hsp sssk>=500&sssk<=505:::mmplay@hsp 10
