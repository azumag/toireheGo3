...
#deffunc netload str _p1@m0

netrequest _p1@m0

repeat@hsp
netexec res@m0
if@hsp res@m0 : break@hsp
await@hsp 50
loop@hsp

if@hsp res@m0 > 0 : return@hsp

neterror estr@m0
dialog@hsp "エラー:"+estr@m0
return@hsp
...
cls@hsp 
color@hsp 0,0,0
picload@hsp "data/img/nowloading.bmp",1
pos@hsp 0,50
...
mes@hsp "バッファに画像読み込み"
buffer@hsp 3,,,
picload@hsp "data/img/mychar.GIF",1
buffer@hsp 4,,,
picload@hsp "data/img/zako.gif",1
buffer@hsp 5,,,
picload@hsp "data/img/alltama256.GIF",1
buffer@hsp 6,,,
picload@hsp "data/img/haikei.gif",1
buffer@hsp 7,1470,64,
picload@hsp "data/img/chuboss1.GIF",1
buffer@hsp 8,,,
picload@hsp "data/img/system.GIF",1
buffer@hsp 9,,,
picload@hsp "data/img/boss.gif",1
buffer@hsp 10,,
picload@hsp "data/img/haikei2men.GIF",1
buffer@hsp 11,,
picload@hsp "data/img/dona1-3.GIF",1
buffer@hsp 12,,
picload@hsp "data/img/stars2.GIF",1
buffer@hsp 13,,
picload@hsp "data/img/bg_chip.GIF",1
buffer@hsp 14,,
picload@hsp "data/img/chainguard.gif",1
buffer@hsp 15,,
picload@hsp "data/img/sks4.bmp",1
buffer@hsp 16,680,1280
picload@hsp "data/img/cannon_charge_fire.GIF",1
buffer@hsp 17,,,
picload@hsp "toire.bmp",1
buffer@hsp 18,,,
picload@hsp "data/img/continue.bmp",1
buffer@hsp 19,,,
picload@hsp "data/img/moresp.bmp",1
buffer@hsp 20,,,
picload@hsp "data/img/perfect.bmp",1
buffer@hsp 21,,,
picload@hsp "data/img/jamm.bmp",1
buffer@hsp 22,,,
picload@hsp "data/img/title.jpg",1
buffer@hsp 24,300,800,
picload@hsp "data/img/staffloll.jpg",1
gsel@hsp 0
mes@hsp "完了"
...
dmloadfname "data/music/stage2.mid",6
dmloadfname "data/music/katyhilla.mid",8
dmloadfname "data/music/katyhill_intro.mid",7
dmloadfname "data/music/Done_Gone.mid",10
dmloadfname "data/music/bbb_f.mid",11
dmloadfname "data/music/bbb_s.mid",13
dmloadfname "data/music/bbb_t.mid",14
dmloadfname "data/music/BBBS.mid",15
dmloadfname "data/music/end.mid",16
dmloadfname "data/music/Morning_Drive.mid",17

ds_load "data/sound/515.wav",1
ds_load "data/sound/bom.wav",2
ds_load "data/sound/zasizasi.wav",3
ds_load "data/sound/bokan.wav",4
ds_load "data/sound/poka.wav",5
ds_load "data/sound/bachi.wav",6
ds_load "data/sound/poi2.wav",7
ds_load "data/sound/kin.wav",8
ds_load "data/sound/boss01c.wav",9
ds_load "data/sound/bishao.wav",10
ds_load "data/sound/laser03.wav",11
ds_load "data/sound/gasha.wav",12
ds_load "data/sound/chinacnon.wav",13
ds_load "data/sound/laser.wav",14

mmload@hsp "data/sound/bachi.wav",7
mmload@hsp "data/sound/bom.wav",5
mmload@hsp "data/sound/poka.wav",6
mmload@hsp "data/sound/ka.mp3",11
mmload@hsp "data/sound/vman.mp3",12
mmload@hsp "data/sound/vman2.mp3",14
mmload@hsp "data/sound/end2.mp3",13
mmload@hsp "data/sound/orange.mp3",15,1
mmload@hsp "data/music/uzygame_s05.mid",2,1
mmload@hsp "data/music/Flexibility.mid",10
...
objsize@hsp 300,30
chkbox@hsp "当たり判定描画（参考程度に)",drawhantei
...
color@hsp 255,255,255
font@hsp "MS ゴシック",16
ftpopen "members-ftp.jcom.home.ne.jp","kabutomusionline","higasig"

ftpdir tmp,"toireheGo"

ftpget "hiscore.bin","net/netscore.bin",0
ftpget "hisname.bin","net/netname.bin",0
ftpget "playfps.bin","net/playfps.bin",0


sdim@hsp netscores,2048
sdim@hsp netscorename,2048
sdim@hsp playfpss,2048
bload@hsp "net/netscore.bin",netscores,2048
bload@hsp "net/netname.bin",netscorename,2048
bload@hsp "net/playfps.bin",playfpss,2048

notesel@hsp netscores
dim@hsp netscorelineint,10
repeat@hsp 10
noteget@hsp netscoreline(cnt@hsp),cnt@hsp
netscorelineint(cnt@hsp) = int@hsp(netscoreline.cnt@hsp)	
loop@hsp
noteunsel@hsp 
notesel@hsp netscorename
sdim@hsp netscorenameline,50,10
repeat@hsp 10
noteget@hsp netscorenameline(cnt@hsp),cnt@hsp
loop@hsp
noteunsel@hsp 
notesel@hsp playfpss
dim@hsp playfpsslineint,10
repeat@hsp 10
noteget@hsp playfpssline(cnt@hsp),cnt@hsp
playfpsslineint(cnt@hsp) = int@hsp(playfpssline.cnt@hsp)	
loop@hsp
noteunsel@hsp 
...
color@hsp 255,0,0
font@hsp "MS ゴシック",40
mes@hsp "Netscore_Ranking"
color@hsp 255,255,255
font@hsp "MS ゴシック",16
mes@hsp:mes@hsp:mes@hsp
foreach@hsp netscorelineint
tmp = cnt@hsp + 1
nagasascore = strlen@hsp (netscorenameline(cnt@hsp))
if@hsp nagasascore >=8 :jotyou="":else@hsp:jotyou="\t"
mes@hsp "\t"+tmp+"\t:"+netscorelineint(cnt@hsp)+"\t:"+netscorenameline(cnt@hsp)+jotyou+"\tFPS="+playfpssline.cnt@hsp
tmp = 0
notesel@hsp nntt
noteadd@hsp netscorenameline(cnt@hsp)
noteunsel@hsp
loop@hsp
mes@hsp:mes@hsp
objsize@hsp 200,32:combox@hsp choice5,,nntt
button@hsp "ﾘﾌﾟﾚｲをﾀﾞｳﾝﾛｰﾄﾞする",*dlreplay
button@hsp "もどる",*clsa
button@hsp "マイランキング",*ranking
stop@hsp
*dlreplay
notesel@hsp nntt
noteget@hsp repname,choice5
noteunsel@hsp
ftpopen "members-ftp.jcom.home.ne.jp","kabutomusionline","higasig"
ftpdir tmp,"toireheGo"


ftpget repname+".rep","replay/"+repname+".rep",0
if@hsp stat@hsp=1 : dialog@hsp repname+"のﾘﾌﾟﾚｲは登録されていません"
if@hsp stat@hsp=0 : dialog@hsp repname+"のﾘﾌﾟﾚｲをダウンロードしました"
ftpclose
...
cls@hsp
mes@hsp "Now loading"
mci@hsp "close stgBgm"

if@hsp stage=1:mci@hsp "open data/music/stage1.mid alias stgBgm":kyokumei="Orange Blossom Special"
...
mci@hsp "set stgBgm time format song pointer"
*mainloop


mci@hsp "status bosBgm position" : position=stat@hsp
...
if@hsp jijiji&128:gosub@hsp *gameovmae
...
mci@hsp "close stgBgm"
mci@hsp "open data/music/boss01a.mid alias bosBgm"
mci@hsp "play bosBgm"
...
if@hsp stage!3{
mci@hsp "close bosBgm":mci@hsp "open data/music/boss01b.mid alias bosBgm"
mci@hsp "play bosBgm"
}
}
...
color@hsp 255,0,0
gmode@hsp 2,163,82
gcopy@hsp 18,0,0,163,82
pos@hsp 124,200+82
font@hsp "MS gosic",25
...
if@hsp keyon =1:goto@hsp *mainloopas
...
if@hsp repup=1:replayf=0:repup=0:button@hsp "次へ",*endingloop:stop@hsp
mes@hsp "リプレイを保存しますか？"
button@hsp "ＯＫ",*ok2:button@hsp "NO",*no2
...
mes@hsp "名前を入れてください"
input@hsp scorename,,,7:button@hsp "score保存",*scorehozon2
...
if@hsp netscorelineint(cnt@hsp) <= score :hozonline=cnt@hsp:hozonok=1 :break@hsp
loop@hsp
...
noteunsel@hsp 
notesel@hsp playfpss
noteadd@hsp str@hsp(heikinfps/1000),hozonline,0
noteunsel@hsp
bsave@hsp "net/netscore.bin",netscores
bsave@hsp "net/netname.bin",netscorename
bsave@hsp "net/playfps.bin",playfpss
ftpput "net/netscore.bin","hiscore.bin"
ftpput "net/netname.bin","hisname.bin"
ftpput "net/playfps.bin","playfps.bin"
...
loop@hsp
mes@hsp:mes@hsp
hozonline2=hozonline+1
if@hsp hozonok != 1{dialog@hsp "残念！スコアが届きませんでした。"
}else@hsp{
if@hsp hozonline=0:mes@hsp "HISCORE!１位にランクイン！":else@hsp:mes@hsp ""+hozonline2+"位にランクイン！"
}

button@hsp "OK",*scorehozon3
stop@hsp
*scorehozon3
if@hsp cont>=1{
if@hsp ababababa=1{
if@hsp hozonok = 1{
dialog@hsp "リプレイをアップロードしますか?",2
if@hsp stat@hsp=6:goto@hsp *replayup
}
}
}
else@hsp{
...
mmstop@hsp
mci@hsp "close stgBgm"
mci@hsp "close bosBgm"
pos@hsp 50,0
picload@hsp "data/img/dore.GIF"
color@hsp 255,0,0
mes@hsp "ゲームおーばー"

mci@hsp "play data/music/sea2.mid"
*cl
mes@hsp
...
stop@hsp
*replayup
bsave@hsp "replay/"+scorename+".rep",replay,frame+100
ftpopen "members-ftp.jcom.home.ne.jp","kabutomusionline","higasig"
ftpdir tmp,"toireheGo"

ftpput "replay/"+scorename+".rep",scorename+".rep"
ftpclose
dialog@hsp scorename+"を/replayに保存しアップロードしました"
repup=1
...
buffer@hsp 23,,,
picload@hsp "data/img/texture1.bmp"
...
if@hsp sssk>=500&sssk<=505:dmstop:mmplay@hsp 10
